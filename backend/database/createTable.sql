...
CREATE TABLE ATTENDANCE(
    ...
    CONSTRAINT ATTENDANCE_SESSIONS_ID_FK FOREIGN KEY(SESSIONS_ID) REFERENCES SESSIONS(SESSIONS_ID),
    CONSTRAINT ATTENDANCE_MEMBERS_ID_FK FOREIGN KEY(MEMBERS_ID) REFERENCES MEMBERS(MEMBERS_ID)
)